...
export const utilityCapabilities = Object.freeze([
  capability({
    ...
    optionFields: [
      ...
      selectOption("compressionMethod", "Compression method", "deflate", ["deflate", "store"]),
      textOption("archivePassword", "Archive password (encrypt)", "", false),
    ],
  ...
  capability({
    ...
    optionFields: [
      ...
      selectOption("roundingMode", "Rounding mode", "round", ["round", "floor", "ceil"]),
    ],
  ...
  capability({
    ...
    optionFields: [
      ...
      numberOption("minEntropy", "Min entropy bits", 64, 32, 256),
    ],
