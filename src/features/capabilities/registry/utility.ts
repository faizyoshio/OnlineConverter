...
export const utilityCapabilities = Object.freeze([
  capability({
    ...
    optionFields: [
      toggleOption("preserveRelativeNames", "Preserve relative names", true),
      numberOption("deflateLevel", "Deflate level", 6, 0, 9),
      selectOption("compressionMethod", "Compression method", "deflate", ["deflate", "store"], true, true),
      textOption("archivePassword", "Archive password (encrypt)", "", false, true),
    ],
  ...
  capability({
    ...
    optionFields: [
      ...
      textOption("fromUnit", "From unit", "m"),
      textOption("toUnit", "To unit", "km"),
      selectOption("precision", "Precision", "auto", ["auto"]),
      numberOption("maxSignificantDigits", "Maximum significant digits", 8, 1, 8),
      selectOption("roundingMode", "Rounding mode", "round", ["round", "floor", "ceil"], true, true),
    ],
  ...
  capability({
    ...
    optionFields: [
      numberOption("length", "Password length", 20, 4, 128),
      toggleOption("uppercase", "Include uppercase", true),
      toggleOption("lowercase", "Include lowercase", true),
      toggleOption("digits", "Include digits", true),
      toggleOption("symbols", "Include symbols", true),
      toggleOption("excludeAmbiguous", "Exclude ambiguous characters", true),
      numberOption("minEntropy", "Min entropy bits", 64, 32, 256, 1, true, true),
    ],
